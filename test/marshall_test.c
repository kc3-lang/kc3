...
TEST_CASE(marshall_plist)
{
  ...
  const s_str expected = STR_1("KC3MARSH"
                               ...
                               "\x11\x00\x16\x2b\x00\x00\x00\x00"
                               "\x00\x00\x00\x11\x01\x16\x00\x00"
...
TEST_CASE(marshall_plist_twice)
{
  ...
  const s_str expected = STR_1("KC3MARSH"
                               ...
                               "\x16\x41\x00\x00\x00\x00\x00\x00"
                               "\x00\x11\x01\x16\x00\x00\x00\x00"
...
TEST_CASE(marshall_tag)
{
  ...
  MARSHALL_TEST_TAG("[1, 2]",
                    ...
                    "\x11\x01\x16\x2b\x00\x00\x00\x00"
                    "\x00\x00\x00\x11\x02\x16\x00\x00"
  ...
  MARSHALL_TEST_TAG("(F128) 3.141592653589793238462643383279502884197" \
                    ...
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x11\x00\x00\x00\x00\x00\x00\x00"
                    "\x08\x32\xc2\x68\x21\xa2\xda\x0f"
  ...
  MARSHALL_TEST_TAG("{1, 2, [3, 4]}",
                    ...
                    "\x16\x00\x00\x00\x00\x00\x00\x00"
                    "\x16\x00\x00\x00\x00\x00\x00\x00"
                    "\x11\x03\x16\x2b\x00\x00\x00\x00"
                    "\x00\x00\x00\x11\x04\x16\x00\x00"
  ...
  MARSHALL_TEST_TAG("Module",
                    ...
                    "\x6c\x65\x1d\x20\x00\x00\x00\x00"
                    "\x00\x00\x00");
  // Map
  MARSHALL_TEST_TAG("%{a: 1, b: 2}",
                    ...
                    "\x01\x00\x00\x00\x61\x01\x00\x00"
                    "\x00\x62\x17\x02\x00\x00\x00\x00"
                    "\x00\x00\x00\x1d\x20\x00\x00\x00"
                    "\x00\x00\x00\x00\x11\x01\x1d\x25"
                    "\x00\x00\x00\x00\x00\x00\x00\x11"
                    "\x02");
  // Cfn
  MARSHALL_TEST_TAG("cfn Tag \"tag_add\" (Tag, Tag, Result)",
                    ...
                    "\x01\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x3b\x00\x00\x00\x00"
                    "\x00\x00\x00\x03\x00\x00\x00\x54"
                    "\x61\x67\x4a\x00\x00\x00\x00\x00"
                    "\x00\x00\x07\x00\x00\x00\x74\x61"
                    "\x67\x5f\x61\x64\x64\x03\x5e\x00"
                    "\x00\x00\x00\x00\x00\x00\x03\x00"
                    "\x00\x00\x54\x61\x67\x6d\x00\x00"
                    "\x00\x00\x00\x00\x00\x03\x00\x00"
                    "\x00\x54\x61\x67\x7c\x00\x00\x00"
                    "\x00\x00\x00\x00\x06\x00\x00\x00"
                    "\x52\x65\x73\x75\x6c\x74\x18\x20"
                    "\x00\x00\x00\x00\x00\x00\x00");
  // Call
  MARSHALL_TEST_TAG("defmodule Test do end",
                    ...
                    "\x09\x00\x00\x00\x64\x65\x66\x6d"
                    "\x6f\x64\x75\x6c\x65\x04\x00\x00"
                    "\x00\x54\x65\x73\x74\x04\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x20\x00"
                    "\x00\x00\x00\x00\x00\x00\x02\x00"
                    "\x00\x00\x00\x00\x00\x00\x1d\x2d"
  ...
  MARSHALL_TEST_TAG("List.reverse([])",
                    ...
                    "\x04\x00\x00\x00\x4c\x69\x73\x74"
                    "\x07\x00\x00\x00\x72\x65\x76\x65"
                    "\x72\x73\x65\x04\x20\x00\x00\x00"
  ...
  MARSHALL_TEST_TAG("a = 1",
                    ...
                    "\x0a\x00\x00\x00\x00\x00\x00\x00"
                    "\x34\x00\x00\x00\x00\x00\x00\x00"
                    "\x01\x00\x00\x00\x3d\x01\x00\x00"
                    "\x00\x61\x04\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x20\x00\x00\x00\x00"
                    "\x00\x00\x00\x02\x00\x00\x00\x00"
                    "\x00\x00\x00\x27\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x25\x00\x00\x00"
                    "\x00\x00\x00\x00\x11\x01\x00\x00"
                    "\x00\x00\x00\x00\x00\x00");
  MARSHALL_TEST_TAG("fn (x) { x * 2 }",
                    ...
                    "\x00\x00\x00\x00\x01\x00\x00\x00"
                    "\x78\x16\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x01\x00\x00\x00\x00\x00"
                    "\x00\x00\x01\x04\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x84\x00\x00\x00"
                    "\x00\x00\x00\x00\x01\x00\x00\x00"
                    "\x2a\x02\x00\x00\x00\x00\x00\x00"
                    "\x00\x27\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\xa2\x00\x00\x00\x00\x00"
                    "\x00\x00\x01\x00\x00\x00\x78\x11"
                    "\x02\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x18\x20\x00\x00\x00\x00\x00"
                    "\x00\x00");
  // Integer
  ...
  MARSHALL_TEST_TAG("quote 1 + 1",
                    ...
                    "\x01\x00\x00\x00\x2b\x22\x04\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x20"
                    "\x00\x00\x00\x00\x00\x00\x00\x02"
                    "\x00\x00\x00\x00\x00\x00\x00\x11"
                    "\x01\x11\x01\x00\x00\x00\x00\x00"
                    "\x00\x00\x00");
  // Var
  MARSHALL_TEST_TAG("(U8) ?",
                    ...
                    "\x02\x00\x00\x00\x55\x38\x00\x21"
  ...
  MARSHALL_TEST_TAG("(Tag) ?",
                    ...
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x38\x00\x00\x00\x00\x00\x00\x00"
                    "\x03\x00\x00\x00\x54\x61\x67\x00"
                    "\x21\x20\x00\x00\x00\x00\x00\x00"
                    "\x00");
  // Complex
  MARSHALL_TEST_TAG("1 +i 2",
                    ...
                    "\x02\x00\x00\x00\x2b\x69\x04\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x20"
                    "\x00\x00\x00\x00\x00\x00\x00\x02"
                    "\x00\x00\x00\x00\x00\x00\x00\x11"
  ...
  MARSHALL_TEST_TAG("%Time{tv_sec: 1 + 1, tv_nsec: 2 + 2}",
                    ...
                    "\x01\x00\x00\x00\x2b\x01\x00\x00"
                    "\x00\x2b\x24\x01\x04\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x20\x00\x00"
                    "\x00\x00\x00\x00\x00\x02\x00\x00"
                    "\x00\x00\x00\x00\x00\x11\x01\x11"
                    "\x01\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x04\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x25\x00\x00\x00\x00\x00"
                    "\x00\x00\x02\x00\x00\x00\x00\x00"
                    "\x00\x00\x11\x02\x11\x02\x00\x00"
                    "\x00\x00\x00\x00\x00\x00");
  // Ptr
  ...
  MARSHALL_TEST_TAG("(PtrFree) 0",
                    ...
                    "\x20\x00\x00\x00\x00\x00\x00\x00"
                    "\x00");
  MARSHALL_TEST_TAG("%KC3.Op{sym: :+, "
                    "callable: cfn Tag \"tag_add\" "
                    "(Tag, Tag, Result)}",
                    "KC3MARSH"
                    "\x13\x00\x00\x00\x00\x00\x00\x00"
                    "\xaa\x01\x00\x00\x00\x00\x00\x00"
                    "\x09\x00\x00\x00\x00\x00\x00\x00"
                    "\x28\x00\x00\x00\x00\x00\x00\x00"
                    "\x30\x00\x00\x00\x00\x00\x00\x00"
                    "\x06\x00\x00\x00\x4b\x43\x33\x2e"
                    "\x4f\x70\x06\x00\x00\x00\x00\x00"
                    "\x00\x00\x1d\x4b\x00\x00\x00\x00"
                    "\x00\x00\x00\x03\x00\x00\x00\x73"
                    "\x79\x6d\x1d\x5b\x00\x00\x00\x00"
                    "\x00\x00\x00\x01\x00\x00\x00\x2b"
                    "\x1d\x69\x00\x00\x00\x00\x00\x00"
                    "\x00\x05\x00\x00\x00\x61\x72\x69"
                    "\x74\x79\x11\x02\x1d\x7d\x00\x00"
                    "\x00\x00\x00\x00\x00\x07\x00\x00"
                    "\x00\x73\x70\x65\x63\x69\x61\x6c"
                    "\x03\x00\x1d\x93\x00\x00\x00\x00"
                    "\x00\x00\x00\x0a\x00\x00\x00\x70"
                    "\x72\x65\x63\x65\x64\x65\x6e\x63"
                    "\x65\x11\x00\x1d\xac\x00\x00\x00"
                    "\x00\x00\x00\x00\x0d\x00\x00\x00"
                    "\x61\x73\x73\x6f\x63\x69\x61\x74"
                    "\x69\x76\x69\x74\x79\x11\x01\x1d"
                    "\xc8\x00\x00\x00\x00\x00\x00\x00"
                    "\x08\x00\x00\x00\x63\x61\x6c\x6c"
                    "\x61\x62\x6c\x65\x21\xdd\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\xf5\x00\x00"
                    "\x00\x00\x00\x00\x00\x08\x00\x00"
                    "\x00\x43\x61\x6c\x6c\x61\x62\x6c"
                    ...
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x01\x01\x1d\x4d\x01\x00"
                    "\x00\x00\x00\x00\x00\x01\x00\x00"
                    "\x00\x2b\x11\x02\x03\x00\x11\x00"
                    "\x11\x01\x18\x63\x01\x00\x00\x00"
                    "\x00\x00\x00\x01\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x7e\x01"
                    "\x00\x00\x00\x00\x00\x00\x03\x00"
                    "\x00\x00\x54\x61\x67\x8d\x01\x00"
                    "\x00\x00\x00\x00\x00\x07\x00\x00"
                    "\x00\x74\x61\x67\x5f\x61\x64\x64"
                    "\x03\xa1\x01\x00\x00\x00\x00\x00"
                    "\x00\x03\x00\x00\x00\x54\x61\x67"
                    "\xb0\x01\x00\x00\x00\x00\x00\x00"
                    "\x03\x00\x00\x00\x54\x61\x67\xbf"
                    "\x01\x00\x00\x00\x00\x00\x00\x06"
                    "\x00\x00\x00\x52\x65\x73\x75\x6c"
                    "\x74\x00\x1b\x20\x00\x00\x00\x00"
                    "\x00\x00\x00");
  MARSHALL_TEST_TAG("%KC3.Op{}",
                    "KC3MARSH"
                    "\x0c\x00\x00\x00\x00\x00\x00\x00"
                    "\x25\x01\x00\x00\x00\x00\x00\x00"
                    "\x09\x00\x00\x00\x00\x00\x00\x00"
                    "\x28\x00\x00\x00\x00\x00\x00\x00"
                    "\x30\x00\x00\x00\x00\x00\x00\x00"
                    "\x06\x00\x00\x00\x4b\x43\x33\x2e"
                    ...
                    "\x00\x00\x20\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x01\x00\x00\x1b\x20\x00"
                    "\x00\x00\x00\x00\x00\x00");
}
