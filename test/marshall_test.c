...
TEST_CASE(marshall_tag)
{
  ...
  MARSHALL_TEST_TAG("%KC3.Op{sym: :+, "
                    ...
                    "KC3MARSH"
                    "\x13\x00\x00\x00\x00\x00\x00\x00"
                    "\xa1\x01\x00\x00\x00\x00\x00\x00"
                    "\x09\x00\x00\x00\x00\x00\x00\x00"
                    ...
                    "\x00\x00\x01\x1d\x44\x01\x00\x00"
                    "\x00\x00\x00\x00\x01\x00\x00\x00"
                    "\x2b\x11\x02\x03\x00\x11\x00\x11"
                    "\x01\x18\x5a\x01\x00\x00\x00\x00"
                    "\x00\x00\x01\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x00\x75\x01\x00"
                    "\x00\x00\x00\x00\x00\x03\x00\x00"
                    "\x00\x54\x61\x67\x84\x01\x00\x00"
                    "\x00\x00\x00\x00\x07\x00\x00\x00"
                    "\x74\x61\x67\x5f\x61\x64\x64\x03"
                    "\x98\x01\x00\x00\x00\x00\x00\x00"
                    "\x03\x00\x00\x00\x54\x61\x67\xa7"
                    "\x01\x00\x00\x00\x00\x00\x00\x03"
                    "\x00\x00\x00\x54\x61\x67\xb6\x01"
                    "\x00\x00\x00\x00\x00\x00\x06\x00"
                    "\x00\x00\x52\x65\x73\x75\x6c\x74"
                    "\x00\x1b\x20\x00\x00\x00\x00\x00"
                    "\x00\x00");
  MARSHALL_TEST_TAG("%KC3.Op{}",
                    "KC3MARSH"
                    "\x0c\x00\x00\x00\x00\x00\x00\x00"
                    "\x1c\x01\x00\x00\x00\x00\x00\x00"
                    "\x09\x00\x00\x00\x00\x00\x00\x00"
                    "\x28\x00\x00\x00\x00\x00\x00\x00"
                    "\x30\x00\x00\x00\x00\x00\x00\x00"
                    "\x06\x00\x00\x00\x4b\x43\x33\x2e"
                    ...
                    "\x00\x00\x10\x00\x00\x00\x00\x00"
                    "\x00\x00\x20\x00\x00\x00\x00\x00"
                    "\x00\x00\x00\x00\x1b\x20\x00\x00"
                    "\x00\x00\x00\x00\x00");
}
