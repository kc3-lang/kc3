...
// REVIEW NOTES:
// This expects a list of only integers and strings, where each
// integer indicates the horizontal (x) displacement of the next
// string, for things like kerning. This is TJ, while the simple
// string is Tj.
