...
s_tag * tag_mul (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_PCOMPLEX:
    switch (b->type) {
    case TAG_PCOMPLEX:
      return tag_init_pcomplex(dest, complex_new_mul(a->data.pcomplex,
                                                     b->data.pcomplex));
    case TAG_F32:
    ...
    case TAG_INTEGER:
      if (! complex_init_integer(&c, &b->data.integer))
        return NULL;
      if (! tag_init_pcomplex(dest, complex_new_mul(a->data.pcomplex,
                                                    &c))) {
        complex_clean(&c);
        return NULL;
      }
  ...
  case TAG_F32:
    ...
    case TAG_PCOMPLEX:
      ...
      return tag_init_pcomplex(dest, complex_new_mul(&c,
                                                     b->data.pcomplex));
    case TAG_F32:
  ...
  case TAG_INTEGER:
    ...
    case TAG_PCOMPLEX:
      ...
      if (! tag_init_pcomplex(dest,
                              complex_new_mul(&c, b->data.pcomplex))) {
        complex_clean(&c);
        return NULL;
      }
      complex_clean(&c);
    ...
    case TAG_S8:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&a->data.integer, &tmp, &tag.data.integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_S16:
  ...
  case TAG_S8:
    ...
    case TAG_INTEGER:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&tmp, &b->data.integer, &tag.data.integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_RATIO:
    ...
    case TAG_S64:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&tmp, &tmp2, &tag.data.integer);
      integer_clean(&tmp);
      integer_clean(&tmp2);
      goto integer_reduce;
    case TAG_SW:
  ...
  case TAG_S16:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s32(&tag, (s32) a->data.s16 * (s32) b->data.s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s32(&tag, (s32) a->data.s16 * (s32) b->data.s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, (s64) a->data.s16 * (s64) b->data.s32);
      goto integer_reduce;
    case TAG_S64:
      integer_init_s16(&tmp, a->data.s16);
      integer_init_s64(&tmp2, b->data.s64);
  ...
  case TAG_U8:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s32(&tag, (s32) a->data.u8 * (s32) b->data.s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s32(&tag, (s32) a->data.u8 * (s32) b->data.s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, (s32) a->data.u8 * (s64) b->data.s32);
      goto integer_reduce;
    case TAG_S64:
      integer_init_u8(&tmp, a->data.u8);
      integer_init_s64(&tmp2, b->data.s64);
    ...
    case TAG_SW:
      ...
      goto integer_reduce;
    case TAG_U8:
      tag_init_u16(&tag, (u16) a->data.u8 * (u16) b->data.u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u32(&tag, (u32) a->data.u8 * (u32) b->data.u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_u64(&tag, (u64) a->data.u8 * (u64) b->data.u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_u8(&tmp, a->data.u8);
      integer_init_u64(&tmp2, b->data.u64);
  ...
  case TAG_U16:
    ...
    case TAG_SW:
      ...
      goto integer_reduce;
    case TAG_U8:
      tag_init_u32(&tag, (u32) a->data.u16 * (u32) b->data.u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u32(&tag, (u32) a->data.u16 * (u32) b->data.u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_u64(&tag, (u64) a->data.u16 * (u64) b->data.u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_u16(&tmp, a->data.u16);
      integer_init_u64(&tmp2, b->data.u64);
  ...
  case TAG_U32:
    ...
    case TAG_S16:
      ...
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, (s64) a->data.u32 * b->data.s32);
      goto integer_reduce;
    case TAG_S64:
      integer_init_u32(&tmp, a->data.u32);
      integer_init_s64(&tmp2, b->data.s64);
    ...
    case TAG_SW:
      ...
      goto integer_reduce;
    case TAG_U8:
      tag_init_u64(&tag, (u64) a->data.u32 * (u64) b->data.u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u64(&tag, (u64) a->data.u32 * (u64) b->data.u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_u64(&tag, (u64) a->data.u32 * (u64) b->data.u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_u32(&tmp, a->data.u32);
      integer_init_u64(&tmp2, b->data.u64);
