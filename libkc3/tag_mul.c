...
s_tag * tag_mul (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_PCOMPLEX:
    switch (b->type) {
    case TAG_PCOMPLEX:
      return tag_init_pcomplex(dest, complex_new_mul(a->data.td_pcomplex,
                                                     b->data.td_pcomplex));
    case TAG_F32:
    ...
    case TAG_INTEGER:
      if (! complex_init_integer(&c, &b->data.td_integer))
        return NULL;
      if (! tag_init_pcomplex(dest, complex_new_mul(a->data.td_pcomplex,
                                                    &c))) {
        complex_clean(&c);
        return NULL;
      }
  ...
  case TAG_F32:
    ...
    case TAG_RATIO:
      ...
      dest->type = TAG_RATIO;
      ratio_mul(&r, &b->data.td_ratio, &dest->data.td_ratio);
      ratio_clean(&r);
      return dest;
    case TAG_S8:
  ...
  case TAG_INTEGER:
    ...
    case TAG_PCOMPLEX:
      ...
      if (! tag_init_pcomplex(dest,
                              complex_new_mul(&c, b->data.td_pcomplex))) {
        complex_clean(&c);
        return NULL;
      }
      complex_clean(&c);
      return dest;
    case TAG_F32:
      return tag_init_f32(dest, integer_to_f32(&a->data.td_integer) *
                          b->data.td_f32);
    case TAG_F64:
    ...
    case TAG_INTEGER:
      ...
      integer_mul(&a->data.td_integer, &b->data.td_integer,
                  &tag.data.td_integer);
      goto integer_reduce;
    case TAG_RATIO:
    ...
    case TAG_S8:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&a->data.td_integer, &tmp, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_S16:
  ...
  case TAG_RATIO:
    ...
    case TAG_F32:
      ...
      dest->type = TAG_RATIO;
      ratio_mul(&a->data.td_ratio, &r, &dest->data.td_ratio);
      ratio_clean(&r);
      return dest;
    case TAG_F64:
    ...
    case TAG_INTEGER:
      ...
      return dest;
    case TAG_RATIO:
      if (! ratio_mul(&a->data.td_ratio, &b->data.td_ratio,
                      &dest->data.td_ratio))
        return NULL;
      dest->type = TAG_RATIO;
      return dest;
  ...
  case TAG_S8:
    ...
    case TAG_INTEGER:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&tmp, &b->data.td_integer, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_RATIO:
    ...
    case TAG_S64:
      ...
      tag.type = TAG_INTEGER;
      integer_mul(&tmp, &tmp2, &tag.data.td_integer);
      integer_clean(&tmp);
      integer_clean(&tmp2);
      goto integer_reduce;
    case TAG_SW:
  ...
  case TAG_STR:
    if (uw_init_cast(&i, &sym_Uw, b)) {
      if (! str_init_mul(&str, &a->data.td_str, i)) {
  ...
  case TAG_U8:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s32(&tag, (s32) a->data.td_u8 * (s32) b->data.td_s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s32(&tag, (s32) a->data.td_u8 * (s32) b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, (s32) a->data.td_u8 * (s64) b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      integer_init_u8(&tmp, a->data.td_u8);
      integer_init_s64(&tmp2, b->data.td_s64);
  ...
  case TAG_U32:
    ...
    case TAG_S16:
      ...
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, (s64) a->data.td_u32 * b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      integer_init_u32(&tmp, a->data.td_u32);
      integer_init_s64(&tmp2, b->data.td_s64);
