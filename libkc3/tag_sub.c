...
s_tag * tag_sub (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_F32:
    ...
    case TAG_RATIO:
      ...
      dest->type = TAG_RATIO;
      ratio_sub(&r, &b->data.ratio, &dest->data.ratio);
      ratio_clean(&r);
      return dest;
    case TAG_S8:
  ...
  case TAG_INTEGER:
    ...
    case TAG_S8:
      ...
      tag.type = TAG_INTEGER;
      integer_sub(&a->data.integer, &tmp, &tag.data.integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_S16:
  ...
  case TAG_S8:
    ...
    case TAG_INTEGER:
      ...
      tag.type = TAG_INTEGER;
      integer_sub(&tmp, &b->data.integer, &tag.data.integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_RATIO:
    ...
    case TAG_S64:
      ...
      tag.type = TAG_INTEGER;
      integer_sub(&tmp, &tmp2, &tag.data.integer);
      integer_clean(&tmp);
      integer_clean(&tmp2);
      goto integer_reduce;
    case TAG_SW:
