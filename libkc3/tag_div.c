...
s_tag * tag_div (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_PCOMPLEX:
    switch (b->type) {
    case TAG_PCOMPLEX:
      return tag_init_pcomplex(dest, complex_new_div(a->data.td_pcomplex,
                                                     b->data.td_pcomplex));
    case TAG_F32:
    ...
    case TAG_INTEGER:
      if (! complex_init_integer(&c, &b->data.td_integer))
        return NULL;
      if (! tag_init_pcomplex(dest, complex_new_div(a->data.td_pcomplex,
                                                    &c))) {
  ...
  case TAG_F32:
    ...
    case TAG_RATIO:
      ...
      dest->type = TAG_RATIO;
      ratio_div(&r, &b->data.td_ratio, &dest->data.td_ratio);
      ratio_clean(&r);
      return dest;
    case TAG_S8:
  ...
  case TAG_INTEGER:
    ...
    case TAG_PCOMPLEX:
      ...
      if (! tag_init_pcomplex(dest,
                              complex_new_div(&c, b->data.td_pcomplex))) {
        complex_clean(&c);
        return NULL;
      }
      complex_clean(&c);
    ...
    case TAG_INTEGER:
      ...
      integer_div(&a->data.td_integer, &b->data.td_integer,
                  &tag.data.td_integer);
      goto integer_reduce;
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      integer_init_s32(&tmp, b->data.td_s8);
      tag.type = TAG_INTEGER;
      integer_div(&a->data.td_integer, &tmp, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_S16:
      integer_init_s32(&tmp, b->data.td_s16);
      tag.type = TAG_INTEGER;
      integer_div(&a->data.td_integer, &tmp, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    ...
    case TAG_SW:
      ...
      goto integer_reduce;
    case TAG_U8:
      integer_init_u32(&tmp, (u32) b->data.td_u8);
      tag.type = TAG_INTEGER;
      integer_div(&a->data.td_integer, &tmp, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_U16:
      integer_init_u32(&tmp, (u32) b->data.td_u16);
      tag.type = TAG_INTEGER;
      integer_div(&a->data.td_integer, &tmp, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
  ...
  case TAG_RATIO:
    ...
    case TAG_F32:
      ...
      dest->type = TAG_RATIO;
      ratio_div(&a->data.td_ratio, &r, &dest->data.td_ratio);
      ratio_clean(&r);
      return dest;
    case TAG_F64:
    ...
    case TAG_INTEGER:
      ...
      return dest;
    case TAG_RATIO:
      if (! ratio_div(&a->data.td_ratio, &b->data.td_ratio,
                      &dest->data.td_ratio))
        return NULL;
      dest->type = TAG_RATIO;
      return dest;
  ...
  case TAG_S8:
...
#endif
    case TAG_INTEGER:
      integer_init_s32(&tmp, (s32) a->data.td_s8);
      tag.type = TAG_INTEGER;
      integer_div(&tmp, &b->data.td_integer, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_RATIO:
    ...
    case TAG_S8:
      ...
      goto integer_reduce;
    case TAG_S16:
      tag_init_s8(&tag, (s8) ((s16) a->data.td_s8 / b->data.td_s16));
      goto integer_reduce;
    case TAG_S32:
      tag_init_s8(&tag, (s8) ((s32) a->data.td_s8 / b->data.td_s32));
      goto integer_reduce;
    case TAG_S64:
      tag_init_s8(&tag, (s8) ((s64) a->data.td_s8 / b->data.td_s64));
      goto integer_reduce;
    case TAG_SW:
      tag_init_s8(&tag, (s8) ((sw) a->data.td_s8 / b->data.td_sw));
      goto integer_reduce;
    case TAG_U8:
      tag_init_s8(&tag, (s8) ((s16) a->data.td_s8 / (s16) b->data.td_u8));
      goto integer_reduce;
    case TAG_U16:
      tag_init_s8(&tag, (s8) ((s32) a->data.td_s8 / (s32) b->data.td_u16));
      goto integer_reduce;
    case TAG_U32:
      tag_init_s8(&tag, (s8) ((s64) a->data.td_s8 / (s64) b->data.td_u32));
      goto integer_reduce;
    case TAG_U64:
      integer_init_s8(&tmp, a->data.td_s8);
      integer_init_u64(&tmp2, b->data.td_u64);
      tag.type = TAG_INTEGER;
      integer_div(&tmp, &tmp2, &tag.data.td_integer);
      integer_clean(&tmp);
      integer_clean(&tmp2);
      goto integer_reduce;
    case TAG_UW:
  ...
  case TAG_S16:
...
#endif
    case TAG_INTEGER:
      integer_init_s32(&tmp, (s32) a->data.td_s16);
      tag.type = TAG_INTEGER;
      integer_div(&tmp, &b->data.td_integer, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s16(&tag, a->data.td_s16 / (s16) b->data.td_s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s16(&tag, a->data.td_s16 / b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s16(&tag, ((s16) ((s32) a->data.td_s16 / b->data.td_s32)));
      goto integer_reduce;
    case TAG_S64:
      tag_init_s16(&tag, ((s16) ((s64) a->data.td_s16 / b->data.td_s64)));
      goto integer_reduce;
    case TAG_SW:
      tag_init_s16(&tag, ((s16) ((sw) a->data.td_s16 / b->data.td_sw)));
      goto integer_reduce;
    case TAG_U8:
      tag_init_s16(&tag, a->data.td_s16 / (s16) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_s16(&tag, (s16) ((s32) a->data.td_s16 / (s32) b->data.td_u16));
      goto integer_reduce;
    case TAG_U32:
      tag_init_s16(&tag, (s16) ((s64) a->data.td_s16 / (s64) b->data.td_u32));
      goto integer_reduce;
    case TAG_U64:
  ...
  case TAG_S32:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s32(&tag, a->data.td_s32 / (s32) b->data.td_s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s32(&tag, a->data.td_s32 / (s32) b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s32(&tag, a->data.td_s32 / b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      tag_init_s32(&tag, (s32) ((s64) a->data.td_s32 / b->data.td_s64));
      goto integer_reduce;
    case TAG_SW:
      tag_init_s32(&tag, (s32) ((sw) a->data.td_s32 / b->data.td_sw));
      goto integer_reduce;
    case TAG_U8:
      tag_init_s32(&tag, a->data.td_s32 / (s32) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_s32(&tag, a->data.td_s32 / (s32) b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_s32(&tag, a->data.td_s32 / (s64) b->data.td_u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_s32(&tmp, a->data.td_s32);
      integer_init_u64(&tmp2, b->data.td_u64);
  ...
  case TAG_S64:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      tag_init_s64(&tag, a->data.td_s64 / b->data.td_s64);
      goto integer_reduce;
    case TAG_SW:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_sw);
      goto integer_reduce;
    case TAG_U8:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_s64(&tag, a->data.td_s64 / (s64) b->data.td_u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_s64(&tmp, a->data.td_s64);
      integer_init_u64(&tmp2, b->data.td_u64);
  ...
  case TAG_SW:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_s8);
      goto integer_reduce;
    case TAG_S16:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      tag_init_sw(&tag, (sw) ((s64) a->data.td_sw / b->data.td_s64));
      goto integer_reduce;
    case TAG_SW:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_sw);
      goto integer_reduce;
    case TAG_U8:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_sw(&tag, a->data.td_sw / (sw) b->data.td_u32);
      goto integer_reduce;
    case TAG_U64:
      integer_init_sw(&tmp, a->data.td_sw);
      integer_init_u64 (&tmp2, b->data.td_u64);
  ...
  case TAG_U8:
...
#endif
    case TAG_INTEGER:
      integer_init_u32(&tmp, a->data.td_u8);
      tag.type = TAG_INTEGER;
      integer_div(&tmp, &b->data.td_integer, &tag.data.td_integer);
      integer_clean(&tmp);
      goto integer_reduce;
    ...
    case TAG_S8:
      ...
      goto integer_reduce;
    case TAG_S16:
      tag_init_s16(&tag, (s16) a->data.td_u8 / b->data.td_s16);
      goto integer_reduce;
    case TAG_S32:
      tag_init_s16(&tag, (s16) ((s32) a->data.td_u8 / b->data.td_s32));
      goto integer_reduce;
    case TAG_S64:
      tag_init_s16(&tag, (s16) ((s64) a->data.td_u8 / b->data.td_s64));
      goto integer_reduce;
    case TAG_SW:
      tag_init_s16(&tag, (s16) ((sw) a->data.td_u8 / b->data.td_sw));
      goto integer_reduce;
    case TAG_U8:
      tag_init_u8(&tag, a->data.td_u8 / b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u16(&tag, (u8) ((u16) a->data.td_u8 / b->data.td_u16));
      goto integer_reduce;
    case TAG_U32:
      tag_init_u32(&tag, (u8) ((u32) a->data.td_u8 / b->data.td_u32));
      goto integer_reduce;
    case TAG_U64:
      tag_init_u64(&tag, (u8) ((u64) a->data.td_u8 / b->data.td_u64));
      goto integer_reduce;
    case TAG_UW:
      tag_init_uw(&tag, (u8) ((uw) a->data.td_u8 / b->data.td_uw));
      goto integer_reduce;
    default:
      goto ko;
    }
  case TAG_U16:
    ...
    case TAG_S16:
      ...
      goto integer_reduce;
    case TAG_S32:
      tag_init_s32(&tag, (s32) a->data.td_u16 / b->data.td_s32);
      goto integer_reduce;
    case TAG_S64:
      tag_init_s32(&tag, (s32) ((s64) a->data.td_u16 / b->data.td_s64));
      goto integer_reduce;
    case TAG_SW:
      tag_init_s32(&tag, (s32) ((sw) a->data.td_u16 / b->data.td_sw));
      goto integer_reduce;
    case TAG_U8:
      tag_init_u16(&tag, a->data.td_u16 / (u16) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u16(&tag, a->data.td_u16 / b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_u16(&tag, (u16) ((u32) a->data.td_u16 / b->data.td_u32));
      goto integer_reduce;
    case TAG_U64:
      tag_init_u16(&tag, (u16) ((u64) a->data.td_u16 / b->data.td_u64));
      goto integer_reduce;
    case TAG_UW:
      tag_init_u16(&tag, (u16) ((uw) a->data.td_u16 / b->data.td_uw));
      goto integer_reduce;
    default:
      goto ko;
    }
  case TAG_U32:
    ...
    case TAG_S32:
      ...
      goto integer_reduce;
    case TAG_S64:
      tag_init_s64(&tag, (s64) a->data.td_u32 / b->data.td_s64);
      goto integer_reduce;
    case TAG_SW:
      tag_init_sw(&tag, (sw) a->data.td_u32 / b->data.td_sw);
      goto integer_reduce;
    case TAG_U8:
    ...
    case TAG_U32:
      ...
      goto integer_reduce;
    case TAG_U64:
      tag_init_u64(&tag, a->data.td_u32 / b->data.td_u64);
      goto integer_reduce;
    case TAG_UW:
      tag_init_uw(&tag, a->data.td_u32 / b->data.td_uw);
      goto integer_reduce;
    default:
      goto ko;
    }
  case TAG_U64:
    ...
    case TAG_SW:
      ...
      goto integer_reduce;
    case TAG_U8:
      tag_init_u64(&tag, a->data.td_u64 / (u64) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_u64(&tag, a->data.td_u64 / (u64) b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_u64(&tag, a->data.td_u64 / (u64) b->data.td_u32);
      goto integer_reduce;
    case TAG_U64:
      tag_init_u64(&tag, a->data.td_u64 / b->data.td_u64);
      goto integer_reduce;
    case TAG_UW:
      tag_init_uw(&tag, a->data.td_u64 / (u64) b->data.td_uw);
      goto integer_reduce;
    default:
      goto ko;
    }
  case TAG_UW:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      if (UW_MAX > S64_MAX && a->data.td_uw > S64_MAX) {
        integer_init_uw(&tmp, a->data.td_uw);
        integer_init_s32(&tmp2, (s32) b->data.td_s8);
        tag.type = TAG_INTEGER;
        integer_div(&tmp, &tmp2, &tag.data.td_integer);
        integer_clean(&tmp);
        integer_clean(&tmp2);
        ...
        return tag_init_s64(dest, (s64) a->data.td_uw / (s64) b->data.td_s8);
    case TAG_S16:
      if (UW_MAX > S64_MAX && a->data.td_uw > S64_MAX) {
        integer_init_uw(&tmp, a->data.td_uw);
        integer_init_s32(&tmp2, (s32) b->data.td_s16);
        tag.type = TAG_INTEGER;
        integer_div(&tmp, &tmp2, &tag.data.td_integer);
        integer_clean(&tmp);
        integer_clean(&tmp2);
        ...
        tag_init_s64(dest, (s64) a->data.td_uw / (s64) b->data.td_s16);
        goto integer_reduce;
      }
    case TAG_S32:
      if (UW_MAX > S64_MAX && a->data.td_uw > S64_MAX) {
        ...
        tag_init_s64(dest, (s64) a->data.td_uw / (s64) b->data.td_s32);
        goto integer_reduce;
      }
    case TAG_S64:
      if (UW_MAX > S64_MAX && a->data.td_uw > S64_MAX) {
        ...
        tag_init_s64(dest, (s64) a->data.td_uw / b->data.td_s64);
        goto integer_reduce;
      }
    case TAG_SW:
      if (a->data.td_uw > SW_MAX) {
        integer_init_uw(&tmp, a->data.td_uw);
        integer_init_sw(&tmp2, b->data.td_sw);
        tag.type = TAG_INTEGER;
        integer_div(&tmp, &tmp2, &tag.data.td_integer);
        ...
        tag_init_sw(&tag, (sw) a->data.td_uw / b->data.td_sw);
        goto integer_reduce;
      }
    case TAG_U8:
      tag_init_uw(&tag, a->data.td_uw / (uw) b->data.td_u8);
      goto integer_reduce;
    case TAG_U16:
      tag_init_uw(&tag, a->data.td_uw / (uw) b->data.td_u16);
      goto integer_reduce;
    case TAG_U32:
      tag_init_uw(&tag, a->data.td_uw / (uw) b->data.td_u32);
      goto integer_reduce;
    case TAG_U64:
      tag_init_uw(&tag, a->data.td_uw / (uw) b->data.td_u64);
      goto integer_reduce;
    case TAG_UW:
