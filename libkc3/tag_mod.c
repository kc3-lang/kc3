...
s_tag * tag_mod (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_F64:
    ...
    case TAG_INTEGER:
      return tag_init_f80
        (dest, fmod(a->data.f64, integer_to_f80(&b->data.integer)));
    case TAG_S8:
    ...
    case TAG_S64:
      return tag_init_f80(dest, fmodl(a->data.f64,
                                       (f80) b->data.s64));
    case TAG_SW:
      return tag_init_f80(dest, fmodl(a->data.f64, (f80) b->data.sw));
    case TAG_U8:
    ...
    case TAG_U64:
      return tag_init_f80(dest, fmodl(a->data.f64,
                                       (f80) b->data.u64));
    case TAG_UW:
      return tag_init_f80(dest, fmodl(a->data.f64, (f80) b->data.uw));
    default:
      goto ko;
    }
  case TAG_F80:
