...
(u64 *u, const s_sym * const *type, const s_tag *tag)
{
  ...
  case TAG_BOOL:
    *u = tag->data.td_bool_ ? 1 : 0;
    return u;
  case TAG_CHARACTER:
    *u = (u64) tag->data.td_character;
    return u;
  case TAG_F32:
    *u = (u64) tag->data.td_f32;
    return u;
  case TAG_F64:
    *u = (u64) tag->data.td_f64;
    return u;
#if HAVE_F80
  case TAG_F80:
    *u = (u64) tag->data.td_f80;
    return u;
#endif
  case TAG_INTEGER:
    *u = integer_to_u64(&tag->data.td_integer);
    return u;
  case TAG_RATIO:
    *u = ratio_to_u64(&tag->data.td_ratio);
    return u;
  case TAG_S8:
    *u = (u64) tag->data.td_s8;
    return u;
  case TAG_S16:
    *u = (u64) tag->data.td_s16;
    return u;
  case TAG_S32:
    *u = (u64) tag->data.td_s32;
    return u;
  case TAG_S64:
    *u = (u64) tag->data.td_s64;
    return u;
  case TAG_STR:
    return u64_init_str(u, &tag->data.td_str);
  case TAG_SW:
    *u = (u64) tag->data.td_sw;
    return u;
  case TAG_U8:
    *u = (u64) tag->data.td_u8;
    return u;
  case TAG_U16:
    *u = (u64) tag->data.td_u16;
    return u;
  case TAG_U32:
    *u = (u64) tag->data.td_u32;
    return u;
  case TAG_U64:
    *u = (u64) tag->data.td_u64;
    return u;
  case TAG_UW:
    *u = (u64) tag->data.td_uw;
    return u;
  case TAG_VOID:
    *u = 0;
    return u;
