...
sw buf_inspect_plist (s_buf *buf, const p_list *list);
sw buf_inspect_plist_paren (s_buf *buf, const p_list *list);
sw buf_inspect_plist_size (s_pretty *pretty, const p_list *list);
