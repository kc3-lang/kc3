...
s_tag * tag_pow (s_tag *a, s_tag *b, s_tag *dest)
{
  ...
  case TAG_COMPLEX:
    switch (b->type) {
    case TAG_COMPLEX:
      return tag_init_complex(dest, complex_new_pow(a->data.complex,
                                                    b->data.complex));
    case TAG_F32:
    ...
    case TAG_INTEGER:
      if (! complex_init_integer(&c, &b->data.integer))
        return NULL;
      if (! tag_init_complex(dest, complex_new_pow(a->data.complex,
                                                   &c))) {
        complex_clean(&c);
        return NULL;
      }
  ...
  case TAG_F32:
    ...
    case TAG_COMPLEX:
      ...
      return tag_init_complex(dest, complex_new_pow(&c,
                                                    b->data.complex));
    case TAG_F32:
  ...
  case TAG_INTEGER:
    ...
    case TAG_COMPLEX:
      if (! complex_init_integer(&c, &a->data.integer))
        return NULL;
      if (! tag_init_complex(dest, complex_new_pow(&c,
                                                   b->data.complex))) {
        complex_clean(&c);
        return NULL;
      }
    ...
    case TAG_S8:
      ...
      dest->type = TAG_INTEGER;
      integer_pow(&a->data.integer, &tmp, &dest->data.integer);
      integer_clean(&tmp);
      return tag_integer_reduce(dest);
    case TAG_S16:
  ...
  case TAG_S8:
    ...
    case TAG_INTEGER:
      ...
      dest->type = TAG_INTEGER;
      integer_pow(&tmp, &b->data.integer, &dest->data.integer);
      integer_clean(&tmp);
      return tag_integer_reduce(dest);
    case TAG_RATIO:
    ...
    case TAG_S64:
      ...
      dest->type = TAG_INTEGER;
      integer_pow(&tmp, &tmp2, &dest->data.integer);
      integer_clean(&tmp);
      integer_clean(&tmp2);
      return tag_integer_reduce(dest);
    case TAG_SW:
  ...
  case TAG_U8:
    ...
    case TAG_RATIO:
      ...
      return dest;
    case TAG_S8:
      tag_init_s32(dest, (s32) a->data.u8 * (s32) b->data.s8);
      return tag_integer_reduce(dest);
    case TAG_S16:
      tag_init_s32(dest, (s32) a->data.u8 * (s32) b->data.s16);
      return tag_integer_reduce(dest);
    case TAG_S32:
      tag_init_s64(dest, (s32) a->data.u8 * (s64) b->data.s32);
      return tag_integer_reduce(dest);
    case TAG_S64:
      integer_init_u8(&tmp, a->data.u8);
      integer_init_s64(&tmp2, b->data.s64);
  ...
  case TAG_U32:
    ...
    case TAG_S16:
      ...
      return tag_integer_reduce(dest);
    case TAG_S32:
      tag_init_s64(dest, (s64) a->data.u32 * b->data.s32);
      return tag_integer_reduce(dest);
    case TAG_S64:
      integer_init_u32(&tmp, a->data.u32);
      integer_init_s64(&tmp2, b->data.s64);
