...
PROTO_MARSHALL(fact_1, const s_fact *);
...
PROTO_MARSHALL(pset_item__tag, const p_set_item__tag *);
...
PROTO_MARSHALL(set__fact, const s_set__fact *);
PROTO_MARSHALL(set__tag, const s_set__tag *);
PROTO_MARSHALL(set_item__fact, const s_set_item__fact *);
PROTO_MARSHALL(set_item__tag, const s_set_item__tag *);
PROTO_MARSHALL(skiplist__fact, const s_skiplist__fact *);
PROTO_MARSHALL(skiplist_node__fact, const s_skiplist_node__fact *);
