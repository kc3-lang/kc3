...
PROTO_MARSHALL_READ(fact_1,               s_fact               );
PROTO_MARSHALL_READ(facts,                s_facts              );
PROTO_MARSHALL_READ(facts_1,              s_facts              );
...
PROTO_MARSHALL_READ(pset_item__fact,      p_set_item__fact     );
PROTO_MARSHALL_READ(pset_item__tag,       p_set_item__tag      );
PROTO_MARSHALL_READ(pskiplist__fact,      p_skiplist__fact     );
PROTO_MARSHALL_READ(pskiplist_node__fact, p_skiplist_node__fact);
PROTO_MARSHALL_READ(pointer,              s_pointer            );
PROTO_MARSHALL_READ(pointer_1,            s_pointer            );
...
PROTO_MARSHALL_READ(ptuple,               p_tuple              );
...
PROTO_MARSHALL_READ(set__tag,             s_set__tag           );
PROTO_MARSHALL_READ(set__fact,            s_set__fact          );
PROTO_MARSHALL_READ(set_item__tag,        s_set_item__tag      );
PROTO_MARSHALL_READ(set_item__fact,       s_set_item__fact     );
PROTO_MARSHALL_READ(skiplist__fact,       s_skiplist__fact     );
PROTO_MARSHALL_READ(skiplist_node__fact,  s_skiplist_node__fact);
PROTO_MARSHALL_READ(struct,               s_struct             );
PROTO_MARSHALL_READ(struct_type,          s_struct_type        );
PROTO_MARSHALL_READ(struct_type_1,        s_struct_type        );
