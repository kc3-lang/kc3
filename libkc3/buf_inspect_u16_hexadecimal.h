...
#ifndef LIBKC3_BUF_INSPECT_U16_hexadecimal_H
#define LIBKC3_BUF_INSPECT_U16_hexadecimal_H

#include "types.h"

sw buf_inspect_u16_hexadecimal (s_buf *buf, const u16 *x);
u8 buf_inspect_u16_hexadecimal_digits (const u16 *x);
sw buf_inspect_u16_hexadecimal_pad (s_buf *buf, u8 size, character pad,
                                   const u16 *x);
sw buf_inspect_u16_hexadecimal_size (s_pretty *pretty, const u16 *x);
