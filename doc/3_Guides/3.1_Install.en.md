...
Adding the KC3 Debian Repository
...
```sh
wget -qO - https://debian.kmx.io/debian/kmx-io.asc | sudo apt-key add -

# or for modern systems:

wget -qO - https://debian.kmx.io/debian/kmx-io.asc | sudo gpg --dearmor -o /etc/apt/trusted.gpg.d/kmx-io.asc
```
