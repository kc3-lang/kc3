...
KC3_TEST_HTTP_SOURCES = \
	...
	"test/http/11_url_encode_component.kc3" \
	"test/http/11_url_encode_component.out.expected" \
	"test/http/11_url_encode_component.ret.expected" \
	"test/http/12_https_encode_form.kc3" \
	"test/http/12_https_encode_form.out.expected" \
	"test/http/12_https_encode_form.ret.expected" \
	"test/http/13_range.kc3" \
	"test/http/13_range.out.expected" \
	"test/http/13_range.ret.expected" \
	"test/http/14_range_response.kc3" \
	"test/http/14_range_response.out.expected" \
	"test/http/14_range_response.ret.expected" \
	"test/http/15_range_large_response.kc3" \
	"test/http/15_range_large_response.out.expected" \
	"test/http/15_range_large_response.ret.expected" \
...
KC3_TEST_HTTPD_SOURCES = \
	...
	"test/httpd/doc/1_KC3/1.01_Introduction.en.md" \
	"test/httpd/doc/1_KC3/1.01_Introduction.fr.md" \
	"test/httpd/doc/1_KC3/1.02_Array.en.md" \
	"test/httpd/doc/1_KC3/1.02_Array.fr.md" \
	"test/httpd/doc/1_KC3/1.03_Block.en.md" \
	"test/httpd/doc/1_KC3/1.03_Block.fr.md" \
	"test/httpd/doc/1_KC3/1.04_Bool.en.md" \
	"test/httpd/doc/1_KC3/1.04_Bool.fr.md" \
	"test/httpd/doc/1_KC3/1.05_Callable.en.md" \
	"test/httpd/doc/1_KC3/1.05_Callable.fr.md" \
	"test/httpd/doc/1_KC3/1.06_Call.en.md" \
	"test/httpd/doc/1_KC3/1.06_Call.fr.md" \
	"test/httpd/doc/1_KC3/1.07_Character.en.md" \
	"test/httpd/doc/1_KC3/1.07_Character.fr.md" \
	"test/httpd/doc/1_KC3/1.08_Complex.en.md" \
	"test/httpd/doc/1_KC3/1.08_Complex.fr.md" \
	"test/httpd/doc/1_KC3/1.09_Cow.en.md" \
	"test/httpd/doc/1_KC3/1.09_Cow.fr.md" \
	"test/httpd/doc/1_KC3/1.10_F32.en.md" \
	"test/httpd/doc/1_KC3/1.10_F32.fr.md" \
	"test/httpd/doc/1_KC3/1.11_F64.en.md" \
	"test/httpd/doc/1_KC3/1.11_F64.fr.md" \
	"test/httpd/doc/1_KC3/1.12_F128.en.md" \
	"test/httpd/doc/1_KC3/1.12_F128.fr.md" \
	"test/httpd/doc/1_KC3/1.13_Ident.en.md" \
	"test/httpd/doc/1_KC3/1.13_Ident.fr.md" \
	"test/httpd/doc/1_KC3/1.14_Integer.en.md" \
	"test/httpd/doc/1_KC3/1.14_Integer.fr.md" \
	"test/httpd/doc/1_KC3/1.15_List.en.md" \
	"test/httpd/doc/1_KC3/1.15_List.fr.md" \
	"test/httpd/doc/1_KC3/1.16_Map.en.md" \
	"test/httpd/doc/1_KC3/1.16_Map.fr.md" \
	"test/httpd/doc/1_KC3/1.17_Ptr.en.md" \
	"test/httpd/doc/1_KC3/1.17_Ptr.fr.md" \
	"test/httpd/doc/1_KC3/1.18_Quote.en.md" \
	"test/httpd/doc/1_KC3/1.18_Quote.fr.md" \
	"test/httpd/doc/1_KC3/1.19_Ratio.en.md" \
	"test/httpd/doc/1_KC3/1.19_Ratio.fr.md" \
	"test/httpd/doc/1_KC3/1.20_Str.en.md" \
	"test/httpd/doc/1_KC3/1.20_Str.fr.md" \
	"test/httpd/doc/1_KC3/1.21_Struct.en.md" \
	"test/httpd/doc/1_KC3/1.21_Struct.fr.md" \
	"test/httpd/doc/1_KC3/1.22_Sym.en.md" \
	"test/httpd/doc/1_KC3/1.22_Sym.fr.md" \
	"test/httpd/doc/1_KC3/1.23_Tuple.en.md" \
	"test/httpd/doc/1_KC3/1.23_Tuple.fr.md" \
	"test/httpd/doc/1_KC3/1.24_Variable.en.md" \
	"test/httpd/doc/1_KC3/1.24_Variable.fr.md" \
	"test/httpd/doc/1_KC3/1.25_Facts.en.md" \
	"test/httpd/doc/1_KC3/1.25_Facts.fr.md" \
	"test/httpd/doc/1_KC3/1.26_Named_block.en.md" \
	"test/httpd/doc/1_KC3/1.26_Named_block.fr.md" \
	"test/httpd/doc/2_HTTPd/index.en.md" \
	"test/httpd/doc/2_HTTPd/index.fr.md" \
	"test/httpd/doc/3_Guides/3.1_Install.en.md" \
	"test/httpd/doc/3_Guides/3.1_Install.fr.md" \
	"test/httpd/doc/3_Guides/3.2_Testing.en.md" \
	"test/httpd/doc/3_Guides/3.2_Testing.fr.md" \
	"test/httpd/doc/3_Guides/3.3_Usage.en.md" \
	"test/httpd/doc/3_Guides/3.3_Usage.fr.md" \
	"test/httpd/doc/3_Guides/3.4_Structure.en.md" \
	"test/httpd/doc/3_Guides/3.4_Structure.fr.md" \
	"test/httpd/doc/3_Guides/3.5_Tutorial.en.md" \
	"test/httpd/doc/3_Guides/3.5_Tutorial.fr.md" \
	"test/httpd/doc/3_Guides/index.en.md" \
	"test/httpd/doc/3_Guides/index.fr.md" \
	"test/httpd/doc/index.en.md" \
	"test/httpd/doc/index.fr.md" \
